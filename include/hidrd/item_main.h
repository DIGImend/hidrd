...
#define HIDRD_ITEM_MAIN_TAG_MIN HIDRD_ITEM_MAIN_TAG_INPUT

#define HIDRD_ITEM_MAIN_TAG_KNOWN_MAX   HIDRD_ITEM_MAIN_TAG_END_COLLECTION

#define HIDRD_ITEM_MAIN_TAG_RESERVED_MIN    0xD
#define HIDRD_ITEM_MAIN_TAG_RESERVED_MAX    0xF

#define HIDRD_ITEM_MAIN_TAG_MAX HIDRD_ITEM_MAIN_TAG_RESERVED_MAX
