...
/**
 * Define case-changing number to token conversion function wrappers, for
 * dynamically allocating converters.
 *
 * @param _t    Type name.
 */
#define HIDRD_TKN_CONV_CASE_DEFSA(_t) \
    char *                                                  \
