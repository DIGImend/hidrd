...
#define PASS_TO_ALT_STRCD(_res, _t, _n, _c, _d) \
    do {                                                        \
        char   *str;                                            \
                                                                \
        str = HIDRD_NUM_TO_ALT_STRCD(_t, _n, _c, _d);           \
        if (str == NULL)                                        \
...
main(int argc, char **argv)
{
    ...
    PASS_TO_ALT_STRCD("0",          test_u8,    0,          null, dec);
    PASS_TO_ALT_STRCD("255",        test_u8,    UINT8_MAX,  null, dec);
    PASS_TO_ALT_STRCD("0",          test_u16,   0,          null, dec);
    PASS_TO_ALT_STRCD("65535",      test_u16,   UINT16_MAX, null, dec);
    PASS_TO_ALT_STRCD("0",          test_u32,   0,          null, dec);
    PASS_TO_ALT_STRCD("4294967295", test_u32,   UINT32_MAX, null, dec);

    PASS_TO_ALT_STRCD("-128",           test_s8,    INT8_MIN,   null, dec);
    PASS_TO_ALT_STRCD("127",            test_s8,    INT8_MAX,   null, dec);
    PASS_TO_ALT_STRCD("-32768",         test_s32,   INT16_MIN,  null, dec);
    PASS_TO_ALT_STRCD("32767",          test_s32,   INT16_MAX,  null, dec);
    PASS_TO_ALT_STRCD("-2147483648",    test_s32,   INT32_MIN,  null, dec);
    PASS_TO_ALT_STRCD("2147483647",     test_s32,   INT32_MAX,  null, dec);
